...
import  PersonalAccountFor  from "../components/SignUp/PersonalAccountFor";
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <SignUpBox sx={{ justifyContent: "space-around", gap: "10px" }}>
            {variant === 0 && (
              <>
                <Box
                  sx={{
                ...
                <Typography sx={{ fontSize: "20px" ,color: "#31476E"}}>
            ...
            {variant === 1 && (
              <PersonalAccountFor returnToFirst={setVariant} />
            )}
